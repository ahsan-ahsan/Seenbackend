...
router.post("/convertRcoinToDiamond",  WalletController.convertRcoinToDiamond);

router.get("/convertRcoinToDiamond",  WalletController.checkRcoinToDiamondConversion);
